...
public class SequenceGeneratorTest {
	...
	public void oneMethod() throws IOException {
		...
		expected.add(createEvent("[?] [test]." + rootFolder.getRoot()
	...
	public void superCtx() throws IOException {
		...
		List<Event> expected = Lists.newLinkedList();
		expected.add(createEvent("[?] [test]."
				+ rootFolder.getRoot().getAbsolutePath() + "/test.java",
		...
		expected.add(createEvent("[?] [test1]."
				+ rootFolder.getRoot().getAbsolutePath() + "/test1.java",
				EventKind.ABSOLUTE_PATH));
